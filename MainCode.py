...
def main():
    ...
    if choice == menu[0]:
        ...
        l_tx=st.number_input("Insert the rate of the exponential distribution for delay-time (λ\u2082)", min_value = 0.0, value = 2.0, help="This parameter defines the rate of the Exponential distribution, which governs the transition from the major defective to the failed state.")
        ...
        b=st.number_input("Insert the false-negative probability for minor inspection ()", min_value = 0.0, max_value=1.0, value = 0.15, help="This parameter represents the probability of not indicating a minor defect during the minor inspection when, in fact, it does exist.")
